...
while(cap.isOpened()):
    ...
    str_seat = 'SEAT Available: '+str(cnt_seat)
    ...
    cv2.putText(frame, str_seat ,(380,40),font,0.7,(255,255,255),2,cv2.LINE_AA)
    cv2.putText(frame, str_seat ,(380,40),font,0.7,(0,255,150),1,cv2.LINE_AA)
